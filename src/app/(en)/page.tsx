      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            {activePlatform === 'payment' && paymentResult && (
              <ResultShell>
                <MetricsGrid>
                  <BigMetric label="Net Amount" value={paymentResult.netAmount} isCurrency primary />
            ...
            {activePlatform === 'target' && targetResult && (
              <ResultShell>
                {targetResult.isValid ? (
                  <>
                    <MetricsGrid>
                      <BigMetric label="Suggested Selling Price" value={targetResult.suggestedPrice} isCurrency primary />
        ...
        <div className="mt-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <Link href="/profit-diagnosis-calculator" className="bg-white rounded-2xl border border-blue-100 p-7 card-shadow hover:card-shadow-lg hover:-translate-y-0.5 transition-all duration-200 group">
              <div className="w-11 h-11 bg-blue-50 rounded-xl flex items-center justify-center mb-4">
                <span className="text-xl font-bold text-blue-600">▦</span>
              </div>
              <h3 className="text-sm font-semibold text-gray-900 group-hover:text-blue-600 transition-colors">{en.tools.profitDiagnosis.name}</h3>
              <p className="text-sm text-gray-500 mt-1.5 leading-relaxed">{en.tools.profitDiagnosis.shortDescription}</p>
            </Link>
          </div>
        </div>
